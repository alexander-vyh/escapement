...
slots:
  always_on_stub:
    claude: "`~/.claude/rules/gate-design.md`"
    codex: "the Escapement `gate-design` rule"
targets:
  claude: claude/skills/gate-design/SKILL.md
  codex: .agents/skills/gate-design/SKILL.md
frontmatter:
  claude:
    name: "gate-design"
...
> ({{slot:always_on_stub}}) carries just the 3-rule checklist; load
